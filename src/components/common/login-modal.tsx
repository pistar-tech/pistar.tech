...
<div className="user-data-form modal-content p-0" style={{height:"90vh",overflow:"hidden", position:"relative", paddingBottom:"28px"}}>
            <BackArrowButton data-bs-dismiss="modal" aria-label="Close" />
<div className="row g-0 h-100">
              {/* Left: forms */}
              {/*scrollabe features so that the bottom buttoms do not get hidden and cut*/}
<div className="col-12 col-lg-6 d-flex flex-column h-100 overflow-auto modal-scroll-area">
<div className={`form-wrapper w-100 p-5 pb-5 ${activeTab==='signup' ? 'is-signup' : 'is-login'}`} style={{maxHeight:"100%", paddingBottom:"56px"}}>
...
<SocialAuthButtons verb="Signup" />
</div>
                 
                  <div className="modal-bottom-spacer" aria-hidden="true"></div>
              </div>
